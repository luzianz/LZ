...
namespace LZ.Windows.ViewModel {
	...
	public partial class ShareTargetViewModel : INotifyPropertyChanged, ILoadCommandContext, IShareCommandContext {
		...
		public event TypedEventHandler<ShareTargetViewModel, IDeferralProvider> Sharing;
		...
		void IShareCommandContext.RaiseSharing(IDeferralProvider args) {
			Sharing?.Invoke(this, args);
		}
