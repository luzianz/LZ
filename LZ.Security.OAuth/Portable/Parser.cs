...
namespace LZ.Security.OAuth
{
    internal static class Parser
	{
		...
		//[Obsolete]
		//public static void ParseQuery(string queryString, out IOAuthAuthorizationToken authorizationToken)
		//{
		//	try
		//	{
		//		var _authorizationToken = new OAuthAuthorizationToken();
		//		var parameters = new Dictionary<string, string>();
		//		ParseQuery(queryString, parameters);
		...
		//			{
		//				case "oauth_token":
		//					_authorizationToken.Token = parameters[kvp.Key];
		//					break;

		//				case "oauth_verifier":
		//					_authorizationToken.Verifier = parameters[kvp.Key];
		//					break;
		//			}
		//		}
		...
		//[Obsolete]
		//public static void ParseQuery(string queryString, out IOAuthRequestToken requestToken)
		//{
		//	try
		//	{
		//		var _requestToken = new OAuthRequestToken();
		//		var parameters = new Dictionary<string, string>();
		//		ParseQuery(queryString, parameters);
		...
		//			{
		//				case "oauth_token_secret":
		//					_requestToken.TokenSecret = parameters[kvp.Key];
		//					break;

		//				case "oauth_token":
		//					_requestToken.Token = parameters[kvp.Key];
		//					break;

		//				case "oauth_callback_confirmed":
		//					_requestToken.IsCallbackConfirmed = bool.Parse(parameters[kvp.Key]);
		//					break;
		//			}
		//		}
		...
		//[Obsolete]
		//public static void ParseQuery(string queryString, out IOAuthAccessToken accessToken)
		//{
		//	try
		//	{
		//		var _accessToken = new OAuthAccessToken();
		//		var parameters = new Dictionary<string, string>();
		//		ParseQuery(queryString, parameters);
		...
		//			{
		//				case "oauth_token_secret":
		//					_accessToken.TokenSecret = parameters[kvp.Key];
		//					break;

		//				case "oauth_token":
		//					_accessToken.Token = parameters[kvp.Key];
		//					break;
		//			}
		//		}
